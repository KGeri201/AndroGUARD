...
The patch is validated through a process involving its application to an app, called \citetitle{SensorBox}~\cite{SensorBox}, which is designed to gather sensor measurements.
...
After applying the patch and retraining the algorithm it was only able to match all the devices with 97.79\% accuracy, even with our few samples. 
