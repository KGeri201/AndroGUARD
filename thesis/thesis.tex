...
\begin{table}[h]
  ...
  \caption{knn classifier results after patch with increased noise level}
...
\begin{table}[h]
  ...
  \caption{knn classifier results after patch with decreased noise level}
